				...
				<div id="doitaccon">
					...
					<div class="boxeSlide" style="overflow:hidden;">
							<div class="sildeShow">
								<ul id="random">
									<li> 
										<a><img src="img/samsung.png" alt="Sam Sung" title="Sam Sung" /></a>
									</li>
									<li> 
										<a><img src="img/sony.png" alt="Sam Sung" title="Sam Sung" /></a>
									</li>
										<li> 
										<a><img src="img/lg.png" alt="Sam Sung" title="Sam Sung" /></a>
									</li>
										<li> 
										<a><img src="img/nokia.png" alt="Sam Sung" title="Sam Sung" /></a>
									</li>
								</ul>
							</div><!--End .sildeShow-->
					</div><!--End .boxeSlide-->
			...
			<div id="noidungfooter">
				...
				<div id="noidung">
					<ul>
						...
						<li>Địa chỉ: TPHCM </li>
						<li>Điện thoại: 09XXXXXX - Hotline:  09XXXXXX</li>
						<li>Email:  dienthoaiabc@gmail.com</li>
					</ul>
				</div><!-- End .noidung -->
				<div id="thanhngang">
				...
				<div id="copyright">
					<p>Sinh Viên : TRẦN NGỌC PHÚC | Lớp : C15-TH01 | Gmail : tranphucx3@gmail.com<p>
				</div><!-- End .copyright -->
